...
int main() {
   ...
   * just the head and/or tail. */
   ...
   /* //Calls Copy-Assignment Operator and Copy-Constructor
   IntList list1;
   list1.push_back(8);
   list1.push_back(5);
   list1.push_back(3);
...
/*    IntList list1;
   ...
   cout << "list1: " << list1 << endl;
   list1.insert_ordered(11);
   cout << "list1: " << list1 << endl;
   list1.insert_ordered(12);
   cout << "list1: " << list1 << endl;
   list1.insert_ordered(13);
   cout << "list1: " << list1 << endl;
   list1.insert_ordered(13);
   cout << "list1: " << list1 << endl;
   list1.insert_ordered(15);
   cout << "list1: " << list1 << endl;
   list1.insert_ordered(15);
   cout << "list1: " << list1 << endl;
   list1.insert_ordered(17);
   cout << "list1: " << list1 << endl;
   list1.insert_ordered(19);
   cout << "list1: " << list1 << endl; */
